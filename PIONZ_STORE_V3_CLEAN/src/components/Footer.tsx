        ...
        <div className="mt-10 pt-6 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-slate-500">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              title="Portal Internal Pemilik Toko (Ctrl+Shift+A)"
              className="flex items-center gap-1 text-slate-600 hover:text-sky-400 transition-colors cursor-pointer p-1 rounded"
            >
              <Lock className="w-3.5 h-3.5" />
              <span className="text-[10px]">Portal Pengelola</span>
            </button>
          </div>
        </div>
      </div>
